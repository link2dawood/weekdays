...
// One downloadable PDF per year (dist/pdfs/kalenteri-<year>.pdf, generated by
...
// button (CalendarYear.jsx/YearCalendar.jsx), the <link rel="alternate">, and
// the associatedMedia schema (all in prerender.js) can't drift apart.
export function calendarPdfPath(y) {
  return `/pdfs/kalenteri-${y}.pdf`;
}
